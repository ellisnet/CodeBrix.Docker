...
/// <summary>
/// The full description of a network, from <c>GET /networks/{id}</c>. It adds the attached
/// containers to what <see cref="NetworkSummary"/> reports.
/// </summary>
public sealed class NetworkInspectResult
{
    ...
    /// <summary>Gets the attached containers, keyed by container id.</summary>
    ...
    /// <summary>Gets the number of containers currently attached to the network.</summary>
    [JsonIgnore]
    public int AttachedContainerCount => Containers?.Count ?? 0;
}
