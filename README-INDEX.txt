...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.Docker.MitLicenseForever - a cross-platform, zero-dependency
      .NET client for the Docker Engine API: container, image, network and
      volume lifecycle with typed resource limits, interactive exec, CPU
      throttling and OOM diagnostics, a container-configuration advisor, and
      containerized image analysis.
